...
public class ApplicationContextTest {
    ...
    public void setUp() throws Exception {
        // get instance of XML-based application context
    }
    ...
    public void loadCorrectDefinitionsFromXmlDifferentWays() throws Exception {
        ...
        // by name and class
        final ParentBean byClassAndName = applicationContext.getBean("parentBean", ParentBean.class);
        assertNotNull("Can't get bean by name and class", byClassAndName);
        // by interface
        final ParentBeanInterface byInterface = applicationContext.getBean(ParentBeanInterface.class);
