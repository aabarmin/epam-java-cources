...
public class Task003Impl implements Task003 {
    ...
    public String[] invert(String[] source) {
        Validator.validateNotNull(source, errorMessageForSourceIfNull);
    ...
    public String[] join(String[] first, String[] second) {
        Validator.validateNotNull(first, second, errorMessageForFirstParameterIfNull,
                errorMessageForSecondParameterIfNull);
    ...
    public String[] filter(String[] source, FilteringCondition condition) {
        Validator.validateNotNull(source, condition, errorMessageForSourceIfNull,
    ...
    public String[] removeElements(String[] source, String[] toRemove) {
        Validator.validateNotNull(source, toRemove, errorMessageForSourceIfNull,
    ...
    public String[] map(String[] source, MappingOperation operation) {
        Validator.validateNotNull(source, operation, errorMessageForSourceIfNull,
