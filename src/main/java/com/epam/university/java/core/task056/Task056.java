 ...
 * Boris to take n-packs of pills and designated a certain period of days to take each pack. During
 * treatment the following conditions must be observed:
 ...
 *
 * In addition, it's prohibited to drink alcohol on the days of taking medication. Boris quite upset
 * about this fact.
 *
 * If the number of packs is more than one, then Boris need to determine the interval between taking
 * medication, if such exists.
 *
 * For example:
 *      The doctor prescribed 4 packs of pills. Each line contains the number of pills in the pack
 *      and period for taking medication (separated by space).
 *
 *      Prescription:
 *      3 1-3
 *      10 3-12
