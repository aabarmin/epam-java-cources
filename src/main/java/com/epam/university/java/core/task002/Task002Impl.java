...
public class Task002Impl implements Task002 {
    String firstStringsMessageForIllegalArgumentException = "first string must have the value";
    String secondStringsMessageForIllegalArgumentException = "second string must have the value";
    String sourceStringsMessageForIllegalArgumentException = "source string must have the value";
    String numbersMessageForIllegalArgumentException = "number should be positive";
    String separatorsStringsMessageForIllegalArgumentException = "separator must have the value";
    String sourceCollectionsMessageForIllegalArgumentException = "sources collection must have the value";
    String gluesMessageForIllegalArgumentException = "glue string must have the value";
    ...
    public String left(String sourceString, int number) {
        ...
        if (sourceString == null)
            throw new IllegalArgumentException(sourceStringsMessageForIllegalArgumentException);
        if (number < 0) throw new IllegalArgumentException(numbersMessageForIllegalArgumentException);
        if (sourceString.length() < number) return sourceString;
