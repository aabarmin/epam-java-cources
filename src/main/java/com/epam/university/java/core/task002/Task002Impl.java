...
public class Task002Impl implements Task002{
    ...
    public boolean isEquals(String firstString, String secondString) {
        if (firstString==null||secondString==null) throw new IllegalArgumentException();
        return firstString.equals(secondString);
    }

    @Override
    public String left(String sourceString, int number) {
        if (sourceString==null||number<0) throw new IllegalArgumentException();
        String outString;
        if (number>sourceString.length()) return sourceString;
    ...
    public String left(String sourceString, String separator) {
        if (sourceString==null||separator==null) throw new IllegalArgumentException();
    ...
    public String[] split(String sourceString, String split) {
        if (sourceString==null||split==null) throw new IllegalArgumentException();
        return sourceString.split(split);
    }

    @Override
    public String join(String[] sourceCollection, String glue) {
        if (sourceCollection==null||glue==null) throw new IllegalArgumentException();
