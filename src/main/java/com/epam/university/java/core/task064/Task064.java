 ...
 *
 * <p>tip: read the rules of the game. Generally,
 * you need just the rank of the poker combinations.
 * Combination is made up of each player's hand and
 * cards on the deck (board).
 */
