...
public class ApplicationContextImpl implements ApplicationContext {
    private final BeanDefinitionRegistry definitionRegistry = new BeanDefinitionRegistryImpl();
    private final BeanDefinitionReader definitionReader =
            new BeanDefinitionReaderImpl(definitionRegistry);
    private final BeanFactory beanFactory = new BeanFactoryImpl(definitionRegistry);

    @Override
    public int loadBeanDefinitions(Resource resource) {
        return definitionReader.loadBeanDefinitions(resource);
    }

    @Override
    public int loadBeanDefinitions(Collection<Resource> resources) {
        return definitionReader.loadBeanDefinitions(resources);
    }
